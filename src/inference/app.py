...
# FIX: Define a robust generation configuration to match the training callback.
...
def generate_text(linearized_graph: str) -> str:
    ...
    messages = [
        {"role": "user", "content": f"""Below is a graph describing a set of entities and their relationships. Write a coherent and fluent paragraph that accurately describes this information.
...
demo = gr.Interface(
    fn=generate_text,
    inputs=gr.Textbox(lines=10, label="Linearized Graph Input", placeholder="Enter graph data here..."),
    ...
    examples=[
        ...
        ["Ag | leader | Harchand_Singh_Longowal. Harchand_Singh_Longowal | deathPlace | Punjab."]
    ],
